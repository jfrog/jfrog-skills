...
description: >-
  ...
  facts. Use when the user asks how to size Artifactory or Xray, which
  deployment pattern to choose, single vs multi site, active-active,
  active-passive, CI/CD separation, Helm/Kubernetes install planning, or
  reference architecture. Fetches live content from jfrog.com/reference-architecture.
metadata:
  role: workflow
---
...
- Read `../jfrog/SKILL.md` for JFrog Platform product vocabulary when helpful.
