...
flowchart TD
    ...
    PC -.->|"prereq"| JF
    PR -.->|"prereq"| JF
    PC -.->|"writes template consumed by"| PR
```
...
| `projects-best-practices-repos.md` | Phase 3+4 doctrine: four-part naming, SDLC stages, virtual aggregator ordering, External-stage pattern, push vs pull sharing |
